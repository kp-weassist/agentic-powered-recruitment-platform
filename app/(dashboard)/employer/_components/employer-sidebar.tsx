...
export function EmployerSidebar() {
  ...
  const navItems = [
    { title: "Overview", href: "/employer", icon: Home },
    { title: "Jobs", href: "/employer/jobs", icon: Briefcase, badge: "5" },
    { title: "Create Job", href: "/employer/jobs/create", icon: Plus },
    { title: "Pipeline", href: "/employer/pipeline", icon: ListChecks },
    { title: "Team", href: "/employer/team", icon: Users },
    { title: "Organization", href: "/employer/organization", icon: Building },
    { title: "AI JD Assistant", href: "/employer/ai-jd-assistant", icon: Sparkles },
    { title: "Analytics", href: "/employer/analytics", icon: BarChart2 },
    ...
    >
      ...
      {!isCollapsed && (
        <div className="border-t p-3 pb-16">
          ...
          >
            <div className="text-sm font-medium mb-2">Post a new role</div>
