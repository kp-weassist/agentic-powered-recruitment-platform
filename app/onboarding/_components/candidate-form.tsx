...
export function CandidateForm({
  ...
  const [education, setEducation] = useState<EducationItem[]>([
    { institution: "", degree: "", field: "", location: "", start_date: "", graduation_date: "", gpa: "", gpa_scale: "", gpa_type: "gpa", coursework: "" },
  ]);
  const [projects, setProjects] = useState<ProjectItem[]>([
    { project_name: "", description: "", start_date: "", end_date: "", date: "", project_link: "", github_link: "" },
  ]);
  ...
  const extractFromResume = async () => {
    ...
    try {
      ...
      else if (typeof data.skills === "string") setSkills(data.skills);
  ...
  const addExperience = () => setExperience((arr) => [...arr, { company: "", position: "", start_date: "", location: "", end_date: "", is_current: false, description: "" }]);
  ...
  const addProject = () => setProjects((arr) => [...arr, { project_name: "", description: "", start_date: "", end_date: "", date: "", project_link: "", github_link: "" }]);
